...
var oEnvelope_eSignBase = new Envelope_Class();
var eSign_Data = clone(oEnvelope_eSignBase);

eSign_Data.updateEnvelopeFromCurrentInfo = function(activeBAId)
{
...
eSign_Data.updateEnvelope = function($el,activeBAId,actionType,actionObject)
{
