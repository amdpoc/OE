...
var Envelope_Class = function()
{
	...
	// *** PRIVILEGED METHODS
	this.setActiveProposal = function(iProposalId)
    {
    ...
    this.getProductsList = function(proposalId)
    {
                        ...
                        var oProductForList =
                            {
                                ...
                                paymentType:oProduct.paymentType
                            };
    ...
    this.setEnvelope = function(aProducts,oCallerData,type,oPrimaryBAAddress)
    {
        console.log("setEnvelope :: aProducts = ", aProducts);
        var oEnvelope = {};

        oEnvelope.envelopeType = type ? type.toUpperCase() : "ESIGN";
        oEnvelope.templateCode = type ? (type == "rop" ? "ESGNRP" : "ESIGN") : "ESIGN";
        ...
        if (oPrimaryBAAddress)
        {
            oEnvelope.streetAddress = oPrimaryBAAddress.street;
            oEnvelope.city = oPrimaryBAAddress.city;
            oEnvelope.stateAbbr = oPrimaryBAAddress.state;
            oEnvelope.zipFive = oPrimaryBAAddress.zipFive;
            oEnvelope.zipFour = oPrimaryBAAddress.zipFour;
            oEnvelope.newRenewalInd = oPrimaryBAAddress.newRenewalInd == "" ? "N" : "R";
        }
        else
        {
            oEnvelope.streetAddress = " ";
            oEnvelope.city = " ";
            oEnvelope.stateAbbr = " ";
            oEnvelope.zipFive = " ";
            oEnvelope.zipFour = " ";
            oEnvelope.newRenewalInd = " ";
        }
            ...
            var oProductData =
                {
                    ...
                    numOfMonths:1,
                    amountToApply:iProductBillingMonthly
                }
    ...
    this.setPrimaryBAAddress = function(oPrimaryBAAddress)
    {
    ...
    this.setEmptyEnvelope = function(oCallerData,oBillingInfo,type,oPrimaryBAAddress)
    {
        var oEnvelope = {};
        var oBA = null;

        oEnvelope.envelopeType = type ? type : "esign";
        oEnvelope.esignEnvelopeId = 0;
        oEnvelope.inPersonInd = false;
        oEnvelope.customerId = oCallerData.custId;
        oEnvelope.businessName = oCallerData.businessName;
    ...
    this.getActiveProposalIndex = function()
    {
        return iActiveProposalIndex;
    };
    ...
    this.getNewEnvelopeBillingInfo = function()
    {
